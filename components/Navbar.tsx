...
import { Code2, Home, Settings, Moon, Sun } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-gray-200 dark:border-gray-800 shadow-sm rounded-full px-6 py-3 flex items-center gap-8 transition-colors duration-300">
        
        {/* Brand Logo */}
        <Link href="/" className="flex items-center gap-2 group">
          <div className="bg-blue-500 text-white p-1.5 rounded-lg group-hover:bg-blue-600 transition-colors">
            <Code2 size={20} />
          </div>
        ...
        {/* Navigation Links */}
        <div className="flex items-center gap-6 border-l border-gray-300 dark:border-gray-700 pl-6 transition-colors duration-300">
          {navLinks.map((link) => {
        ...
        <div className="flex items-center gap-4 ml-2 border-l border-gray-300 dark:border-gray-700 pl-6">
          <a 
